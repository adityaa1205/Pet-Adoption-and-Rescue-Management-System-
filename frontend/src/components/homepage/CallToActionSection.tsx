        ...
        <div className="animate-fadeInUp">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              ...
              className="animate-glow bg-white text-light-secondary dark:text-dark-secondary px-10 py-5 rounded-full text-xl font-bold hover:bg-gray-100 transition-all transform hover:scale-105 flex items-center space-x-3 shadow-2xl"
            >
