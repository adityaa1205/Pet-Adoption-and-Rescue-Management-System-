...
//   // Keep only gender and role (superuser) filters
...
//         items = data as ExtendedAdminUser[];
//       } else if (data && Array.isArray((data as any).results)) {
//         items = (data as any).results as ExtendedAdminUser[];
//       } else {
...
//   if (loading) {
//     return (
//       <div className="flex items-center justify-center h-64 bg-gradient-to-br from-gray-50 to-orange-100">
...
//   return (
//     <div className="space-y-6 pb-10 bg-gradient-to-br from-gray-50 to-orange-50 min-h-screen">
//       {/* Header */}
//       <div className="flex justify-between items-center">
//         <div>
//           <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight drop-shadow-lg">Users Management</h1>
//           <p className="text-gray-600 mt-2 text-lg">Manage registered users on the platform</p>
//         </div>

//         <div className="flex items-center gap-3">
//           <div className="bg-gradient-to-r from-blue-400 to-purple-400 text-white px-5 py-2 rounded-xl font-semibold shadow-lg scale-100 hover:scale-105 transition-transform duration-200">Total Users: {users.length}</div>
//           {/* NOTE: Add Profile button intentionally removed as requested */}
//         </div>
//       </div>

//       {/* Error State */}
//       {error && (
//         <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center justify-between shadow-md">
//           <span>{error}</span>
//           <button onClick={fetchUsers} className="flex items-center space-x-2 text-sm font-semibold text-red-700 hover:text-red-900">
...
//       {/* Search + Filters */}
//       <div className="bg-white rounded-lg shadow p-4 flex items-center gap-3 relative">
//         <input
//           type="text"
//           placeholder="Search users by name or email..."
//           value={searchTerm}
//           onChange={(e) => setSearchTerm(e.target.value)}
//           className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg shadow-sm"
//         />

//         {/* Filters button (replaces inline selects) */}
//         <div className="relative">
//           <button
//             onClick={() => setShowFilters((s) => !s)}
//             className="ml-3 inline-flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
...
//           {showFilters && (
//             <div ref={filtersRef} className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-100 p-4 z-40">
...
//                     className="px-3 py-1 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg text-sm font-semibold hover:scale-[1.01] transition-transform"
//                   >
//                     Apply
//                   </button>
//                 </div>
...
//           <div
//             key={u.id}
//             className="bg-white rounded-2xl shadow-xl p-7 border border-gray-100 hover:shadow-2xl hover:scale-[1.03] transition-all duration-200 relative group cursor-pointer"
//           >
...
//               <div>
//                 <h3 className="font-bold text-gray-900 text-lg group-hover:text-blue-700 transition-colors">{u.username}</h3>
//                 <p className="text-sm text-gray-600">{u.gender ?? 'Not specified'}</p>
//               </div>
//             </div>
